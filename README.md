...
![An agent writes code, the stop hook fires, three rules come back broken, the check took 0.533 s, and the agent repairs the code](examples/demo/stop-rules-demo.svg)
