...
- `.stop-rules/`, so teammates and cloud agents get the check with nothing to install. On a
  default install that is one file of 351 KB. In `functions` mode it also holds the parser and
